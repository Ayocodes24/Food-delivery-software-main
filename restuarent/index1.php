...
if(isset($_POST['shop_number'])) { // Check if $_POST['shop_number'] is set
    $shop_number = $_POST['shop_number'];
    $_SESSION['shop_number'] = $shop_number;
    $details_result = $conn->query("SELECT * FROM `shop-list` WHERE shop_number = '$shop_number'")->fetch_assoc(); // Corrected SQL query syntax
    ...
    // Handle case where $_POST['shop_number'] is not set
...
<body>
    ...
    <div class="footer">
        <div class="box-container">
            ...
            <div class="box" style="margin-left:100px;">
                <h2>follow us</h2>
                <a href="#"><i class="fab fa-instagram"></i> Indsstagram</a>
